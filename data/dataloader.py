...
from data.base_dataloader import BaseDataset, get_params, get_transform, normalize
...
class StereoDataloader(Dataset):
    ...
    def __init__(self,opt):
        ...
        for line in range(n_line):
            #print('arr[line][0]>>', arr[line][0].decode("utf-8"))
            self.__left.append(dataroot + arr[line][0].decode("utf-8"))
            self.__right.append(dataroot + arr[line][1].decode("utf-8"))
    ...
    def augument_image_pair(self, left_image, right_image):
        ...
        left_image_aug  =  left_image * random_brightness
        right_image_aug = right_image * random_brightness
